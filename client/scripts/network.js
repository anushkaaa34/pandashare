...
//       case "header":
//         console.log("header");
//         Events.fire("h", JSON.stringify(msg));
//         break;
//       case "peers":
...
//     this._filesQueue = [];
//     this._busy = false;
//     this.onmessage = (e) => this._onMessage(e.detail);
//     Events.on("h", (e) => this._onMessage(e.detail));
//   }
...
// //     console.log(this.peers[message.to]);
// //     console.log(message.files);
// //     // this._onPeers([message.to]);
// //     if (this.peers[message.to]) {
// //       // this.peers[message.to].refresh();
// //       this.peers[message.to].sendFiles(message.files);
// //       return;
// //     }
// //     // if (window.isRtcSupported && message.to.rtcSupported) {
// //     //   this.peers[message.to] = new RTCPeer(this._server, message.to);
// //     //   console.log("case-1");
// //     // } else {
...
//       }
//       this.peers[peer.id] = new RTCPeer(this._server, peer.id);
//       // if (window.isRtcSupported && peer.isRtcSupported) {
//       //   this.peers[peer.id] = new RTCPeer(this._server, peer.id);
//       // } else {
//       //   this.peers[peer.id] = new WSPeer(this._server, peer.id);
//       // }
...
//   //   this._server = server; // Set the server instance
//   //   this._peerId = peerId;
//   // }
//   _send(message) {
...
window.URL = window.URL || window.webkitURL;
window.isRtcSupported = !!window.RTCPeerConnection;
console.log(window.isRtcSupported);
